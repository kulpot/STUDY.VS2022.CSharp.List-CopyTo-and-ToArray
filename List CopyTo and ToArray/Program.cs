...
//ref link:https://www.youtube.com/watch?v=H0Z_dbCP3mQ&list=PLRwVmtr-pp07QlmssL4igw1rnrttJXerL&index=35
...
class MainClass
{
    ...
    //}
    //static bool trueforallNORNMALMethod(int age) { return age >= 18; }
    static void Main()
    {
        // -- List CopyTo, ToArray --
        MeList<int> myPartyAges = new MeList<int> { 35, 39, 10, 42, 88, 42, 99 };
        //List<int> myPartyAges = new List<int> { 35, 39, 10, 42, 88, 42, 99 };
        int[] myPartyAgesAsArray = myPartyAges.ToArray();   // Faster Copy
        myPartyAges[0] = 555;
        //int[] myPartyAgesAsArray = new int[myPartyAges.Count];
        //myPartyAges.CopyTo(myPartyAgesAsArray);




        // -- List ConvertAll --    convert to any Type
        //List<int> myPartyAges = new List<int> { 35, 39, 10, 42, 88, 42, 99 };
        //MeList<int> myPartyAges = new MeList<int> { 35, 39, 10, 42, 88, 42, 99 };
        //List<string> myPartyAgesAsString = myPartyAges.ConvertAll(Converter < int, string
        //List<string> myPartyAgesAsString = myPartyAges.ConvertAll(age => age.ToString());
        //MeList<string> myPartyAgesAsString = myPartyAges.ConvertAll(age => age.ToString());
        //List<string> myPartyAgesAsString = new List<string>();
        //foreach (int age in myPartyAges)
        //    myPartyAgesAsString.Add(age.ToString());
        //myPartyAgesAsString.ForEach(Console.WriteLine);
        ...
        //myPartyAges.ForEach(Console.WriteLine);
        //myPartyAges.ForEach(age => Console.Write(age + " "));
        ...
        //List<int> myPartyAges = new List<int> { 35, 39, 42, 10, 88, 42, 99 };
        //if (myPartyAges.TrueForAll(age => age >= 18))
        //if (myPartyAges.TrueForAll(trueforallNORNMALMethod))
        //    Console.WriteLine("Parrrrrrrrrtyyyyyyyyyy!");
        //else
        //    Console.WriteLine("Bust out the hot chocolate.");

        //foreach (int age in myPartyAges)
        //    if(age < 18)
        //    {
        //        Console.WriteLine("Oh no, the party cannot get wild.");
        //        break;
        //    }
